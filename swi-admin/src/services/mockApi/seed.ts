...
export const SEED_EMPLOYEES: Employee[] = [
  {
    ...
    allergies: null,
    status: 'good',
    last_location: { lat: -23.55, lng: -46.63, updated_at: minutesAgo(2) },
  ...
  },
  {
    ...
    status: 'good',
    last_location: { lat: -23.55, lng: -46.64, updated_at: minutesAgo(1) },
    created_at: daysAgo(45),
  },
  {
    id: 'e_003',
    org_id: SEED_ORG_ID,
    full_name: 'Carla Pinto',
    cpf: '333.333.333-33',
    blood_type: 'B+',
    allergies: null,
    status: 'alert',
    last_location: { lat: -23.56, lng: -46.62, updated_at: minutesAgo(3) },
  ...
  },
  {
    ...
    allergies: null,
    status: 'good',
    last_location: { lat: -23.54, lng: -46.65, updated_at: minutesAgo(5) },
    created_at: daysAgo(15),
  },
  {
    id: 'e_005',
    org_id: SEED_ORG_ID,
    full_name: 'Eduarda Reis',
    cpf: '555.555.555-55',
    blood_type: 'O-',
    allergies: 'Lactose',
    status: 'low',
    last_location: { lat: -23.57, lng: -46.61, updated_at: minutesAgo(10) },
  ...
  },
  {
    ...
    allergies: null,
    status: 'good',
    last_location: { lat: -23.55, lng: -46.66, updated_at: minutesAgo(1) },
    created_at: daysAgo(50),
  },
  {
    id: 'e_007',
    org_id: SEED_ORG_ID,
    full_name: 'Gabriela Nunes',
    cpf: '777.777.777-77',
    blood_type: 'O+',
    allergies: null,
    status: 'good',
    last_location: { lat: -23.54, lng: -46.62, updated_at: minutesAgo(4) },
    created_at: daysAgo(12),
  },
  {
    id: 'e_008',
    org_id: SEED_ORG_ID,
    full_name: 'Henrique Tavares',
    cpf: '888.888.888-88',
    blood_type: 'B-',
    allergies: null,
    status: 'offline',
  ...
  },
  {
    ...
    allergies: null,
    status: 'good',
    last_location: { lat: -23.55, lng: -46.62, updated_at: minutesAgo(6) },
    created_at: daysAgo(18),
  },
  {
    id: 'e_010',
    org_id: SEED_ORG_ID,
    full_name: 'Joao Vinicius',
    cpf: '101.010.101-01',
    blood_type: 'AB+',
    allergies: 'Frutos do mar',
    status: 'alert',
    last_location: { lat: -23.58, lng: -46.6, updated_at: minutesAgo(8) },
  ...
  },
  {
    ...
    allergies: null,
    status: 'good',
    last_location: { lat: -23.54, lng: -46.63, updated_at: minutesAgo(2) },
    created_at: daysAgo(25),
  },
  {
    id: 'e_012',
    org_id: SEED_ORG_ID,
    full_name: 'Lucas Pires',
    cpf: '131.313.131-13',
    blood_type: 'A+',
    allergies: null,
    status: 'good',
    last_location: { lat: -23.56, lng: -46.64, updated_at: minutesAgo(3) },
