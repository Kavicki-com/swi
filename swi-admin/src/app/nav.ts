...
// Order, labels and icons match the dashboard sidebar and the MapsGeneral
// compact side-menu. Pages that need badge overlays (e.g. "+9" unread
// counts on /reports and /alerts in the map view) apply them via
// `withBadges`.
