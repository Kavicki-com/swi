...
import { Icon, Title, useTheme } from '@kavicki/swi-design-system';

// Figma 348:10434 — bottom-sheet modal "Política de privacidade".
// Aberto via `presentation: 'transparentModal'` igual ao support modal.
// Backdrop pressable + X close fecham via router.back. Content é
// ScrollView com policy text Inter Regular 14 content.dark.
