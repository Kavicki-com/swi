// Constantes de desenho da moldura decorativa do dashboard e do divisor
...
export const DIVIDER_GRAD_MID = '#62BB81';

export const BG_DECOR_PATH =
...
export const BG_DECOR_W = 360;
export const BG_DECOR_H = 347.935;
